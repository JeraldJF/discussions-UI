export const urlConfig = {
    ...
    votePost: (pid: number) => `${urlConfig.apiBasePath()}/v3/posts/${pid}/vote`,
    replyPost: (tid: number) => `${urlConfig.apiBasePath()}/v3/topics/${tid}`,
    bookmarkPost: (pid: number) => `${urlConfig.apiBasePath()}/v3/posts/${pid}/bookmark`,
